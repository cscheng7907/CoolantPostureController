...
namespace ServerSuperIO.Modbus.Message
{
	internal class ReadWriteMultipleRegistersRequest : AbstractModbusMessage, IModbusRequest
    {
        ...
        public override string ToString()
        {
          ...
          string msg = "Write "+_writeRequest.NumberOfPoints.ToString ()+ " holding registers starting at address "+_writeRequest.StartAddress.ToString ()+", and read "+_readRequest.NumberOfPoints.ToString ()+" registers starting at address "+_readRequest.StartAddress.ToString ()+".";
